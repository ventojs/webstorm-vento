...
%include includes/keywords-default.flex
%include includes/keywords.flex
%include includes/no-keywords.flex
%include includes/variables.flex

< DEFAULT, DEFAULT_VALUE, DEFAULT_BLOCK_MODE, DEFAULT_IIFE, EXPORT, FILE, FOR, FRAGMENT, FUNCTION, FUNCTION_ARGS, FUNCTION_LAMBDA, IF, IMPORT, KEYWORDS, KEYWORDS_CLOSE, NOKEYWORDS, SET, SET_BLOCK_MODE, SET_VALUE, SET_DESTRUCTURE_VARS, EXPRESSION,  INCLUDE, LAYOUT, SLOT, ECHO> {
