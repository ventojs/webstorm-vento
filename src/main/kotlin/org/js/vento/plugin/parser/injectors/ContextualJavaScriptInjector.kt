...
class ContextualJavaScriptInjector : MultiHostInjector {
    override fun getLanguagesToInject(registrar: MultiHostRegistrar, context: PsiElement) {
        ...
        if (allJsElements.isNotEmpty()) {
            ...
            if (firstElement is JavaScripElement || firstElement is VariableElement) {
...
//                            println("\n// Variable $index evaluation\noutput_$index = "+element.text)
    ...
    override fun elementsToInjectIn(): List<Class<out PsiElement>> = listOf(JavaScripElement::class.java, VariableElement::class.java)
    ...
    private fun findAllJavaScriptElements(file: PsiFile): List<PsiElement> {
        ...
        PsiTreeUtil
            .findChildrenOfType(file, JavaScripElement::class.java)
