...
class IncludeTestCase(name: String) : BaseLexerTestCase(name) {
    ...
    fun `test include with pipe`() {
        lexAndTest(
            ...
            arrayOf("{{", "include", "\"myfile.vto\"", "|>", "toUpperCase", "}}"),
        )
    }
    ...
    fun `test include with data`() {
        lexAndTest(
            ...
            arrayOf("{{", "include", "\"myfile.vto\"", "{", "salutation: ", "\"Good bye\"", "}", "}}"),
        )
    }
    ...
    fun `test include with data then pipe`() {
        lexAndTest(
            ...
            arrayOf("{{", "include", "\"myfile.vto\"", "{", "salutation: ", "\"Good bye\"", "}", "|>", "toUpperCase", "}}"),
        )
    }
    ...
    fun `test broken include with pipe then data`() {
        lexAndTest(
            ...
            arrayOf("{{", "include", "\"myfile.vto\"", "|>", "toUpperCase", "{", "salutation: ", "\"Good bye\"", "}", "}}"),
        )
    }
}
